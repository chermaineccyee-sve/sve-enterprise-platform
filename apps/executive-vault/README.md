...
- **All data is mock data**, written in `data.js` for this prototype (VT Worldwide, MRE Asia, Nusantara Project, SVE Group Enterprise Platform, Internal Governance, and ~25 illustrative documents). None of it comes from a real Google Drive account.
...
Executive Home · My Document Vault (Folder View + Intelligent View/Registry, saved views, filters, sort) · Clients & Engagements / Projects & Programmes (workspace list + individual workspace with Overview/Documents/Meetings & Decisions/Action Items & Deliverables/Archive tabs) · Universal Search (metadata vs. content-match distinction) · Document Detail (slide-in preview drawer, used everywhere a document is opened) · Executive Inbox · Archive · Tasks / Follow-Up · Meetings & Decisions · Tags & Classification (confidentiality tier legend) · Templates · Settings · Google Drive (placeholder).

Try the search examples from the brief this was built against: **"VT overtime policy," "Nusantara minutes September," "MRE proposal," "HR-124," "Eric review," "Labuan fund," "Performance Management."**
