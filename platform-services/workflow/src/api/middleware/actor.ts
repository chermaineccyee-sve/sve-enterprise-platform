 ...
 * session-cookie bridge — mirrors platform-services/hrms's own
...
function assertTrustedOriginForCookieAuthenticatedWrite(req: IncomingMessage, container: WorkflowContainer): void {
