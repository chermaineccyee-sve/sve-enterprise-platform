...
function serializeStep(s: WorkflowStep) {
  return {
    ...
    assignedPermissionKeyPrivileged: s.assignedPermissionKeyPrivileged,
...
function parseStepInput(body: Record<string, unknown>) {
  return {
    ...
    assignedPermissionKeyPrivileged: typeof body.assignedPermissionKeyPrivileged === "string" ? body.assignedPermissionKeyPrivileged : null,
