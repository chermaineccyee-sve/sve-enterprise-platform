 ...
 * already-accepted SVEGIP session-cookie bridge to Workflow. Mirrors
...
import type { WorkflowContainer } from "../../src/composition/container.ts";
...
function fakeContainer(overrides: Partial<WorkflowContainer> = {}): WorkflowContainer {
  return {
    users: {
      findById: async () => null,
